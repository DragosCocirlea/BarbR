package ro.akaaka.barbr.network

import android.app.Activity
import android.content.Intent
import android.widget.Toast
import ro.akaaka.barbr.activities.SignIn.SignInActivity
...
object NetworkUtils {
    private const val serverIP = "http://ec2-18-198-210-184.eu-central-1.compute.amazonaws.com:5000/"
    ...
    fun makeRefreshingRequest(request: Request, successFunction : (String) -> Unit, activity: Activity, hasParentActivity: Boolean) {
        val prefs = activity.getSharedPreferences("ro.akaaka.barbr.prefs", 0)
